...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference("Floor.count") do
      post floors_url, params: { floor: { block_id: @floor.block_id, number: @floor.number } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { block_id: @floor.block_id, number: @floor.number } }
